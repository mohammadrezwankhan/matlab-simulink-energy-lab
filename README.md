...
| [Temperature-aware battery model](examples/battery-thermal-model/README.md) | How do loss, entropic heat, cooling, resistance feedback, and project-defined limit exposure affect lumped cell temperature? | `check_battery_thermal_model.m` | Base MATLAB |
