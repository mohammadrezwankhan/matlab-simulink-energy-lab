...
Small, inspectable MATLAB examples for battery and power-electronics modeling. Each example states its assumptions, includes a no-plot validation check, and connects simulation output to an engineering question.
...
The battery example uses only base MATLAB functionality. Release `v0.1.0` was verified with MATLAB R2026a.
...
The [examples index](examples/README.md) connects the executable models to validation, reproducibility, unit-consistency, and review guidance. Repository-wide conventions are documented in [modeling standards](notes/modeling-standards.md).
...
If these examples are useful, starring the repository helps other energy-modeling practitioners discover it.
