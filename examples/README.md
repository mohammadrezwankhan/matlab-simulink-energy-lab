...
| [Switching closed-loop buck](converter-switching-closed-loop-model/README.md) | Connects bounded period-sampled control to an event-aligned PWM plant with diode, copper, and source-backed nominal SiC switch losses. | `converter-switching-closed-loop-model/simulate_switching_closed_loop_buck.m`, `converter-switching-closed-loop-model/check_switching_closed_loop_buck.m` | `run_switching_closed_loop_buck`, `check_switching_closed_loop_buck` |
